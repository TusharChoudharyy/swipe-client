...
const benefits = [
    { icon: "✅", text: "Blazing-Fast Delivery – Sub-second global message reach" },
    { icon: "✅", text: "99.99% Uptime SLA – Trusted by top affiliate networks" },
    { icon: "✅", text: "Secure & Compliant – GDPR, DLT, and carrier verified" },
    { icon: "✅", text: "Real-Time Analytics – Track open rates, clicks, and errors" },
];
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-6 text-base text-[#183ec2]">
                        Scale transactional delivery with enterprise-grade uptime and global reach.
                    </p>
