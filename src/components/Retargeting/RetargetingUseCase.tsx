...
const featureTabs = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "🛡️",
        stats: [
          "⚠️ Quote abandon flows",
          "🧾 Policy renewal nudges",
          "🎯 Risk profile audiences",
    ...
    items: [
      {
        ...
        icon: "👗",
        stats: [
          "🔄 Cart abandon retargets",
          "📸 Lookbook ad sequences",
          "🎯 Price drop alerts",
          "💳 Promo code pushes",
        ],
      ...
      },
      {
        ...
        icon: "📦",
        stats: [
          "📥 Product page revisit ads",
          "🎥 Demo video retargets",
          "🔁 Bundle upsell flows",
          "🛠️ Warranty offer reminders",
        ],
      ...
      },
      {
        ...
        stats: [
          ...
          "💄 New shade announcements",
          "🎁 Sample to purchase ads",
          "🔄 Review solicitation flows",
        ],
      ...
      },
      {
        ...
        stats: [
          ...
          "🍽️ Recipe retargeting ads",
          "🔄 Trial ending reminders",
          "📊 Ingredient spotlight ads",
        ],
    ...
    items: [
      {
        ...
        icon: "🎰",
        stats: [
          "🔄 Deposit abandon sequences",
          "🎁 Welcome bonus reactivation",
          "📲 App session retargets",
          "🎯 High roller segments",
        ],
      ...
      },
      {
        ...
        stats: [
          "📈 Lineup revisit ads",
          "🏆 Reward tier retargets",
          "🔄 Weekly recap sequences",
    ...
    items: [
      {
        ...
        icon: "📊",
        stats: [
          "🔄 Dashboard revisit reminders",
          "📥 Report-download prompts",
      ...
      {
        title: "Security Suites",
        icon: "🔐",
        stats: [
          "⚠️ Scan complete retargets",
          "🔄 Renewal time campaigns",
          "💼 Enterprise offer pushes",
          "🔗 Integration guides ads",
        ],
      ...
      },
      {
        ...
        icon: "🛠️",
        stats: [
          "📅 Onboarding reminder ads",
          "🔄 Feature tutorial invites",
          "📥 Template download nudges",
          "🎯 Workflow boosting tips",
        ],
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 px-4 max-w-4xl mx-auto">
           Re-engage lost customers with AI-powered retargeting campaigns
          </h2>
          <p className="text-m  mx-auto max-w-3xl">
            Boost conversion rates by reconnecting with bounced visitors through smart segmentation and personalized ad experiences.
          </p>
        </div>
...
export default RetargetingUseCase;
