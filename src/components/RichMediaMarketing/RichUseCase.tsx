  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "🧾",
        stats: [
          "📞 Interactive Contact Flows",
          "📈 Pipeline Builders",
          "🔁 Automation Loops",
          "🧾 Drag-Drop UI Previews",
        ],
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 px-4 max-w-4xl mx-auto">
           Interactive creatives driving deeper customer engagement journeys
          </h2>
          <p className="text-m  mx-auto max-w-3xl">
            Deliver immersive ad formats like video, carousel, and gamified experiences that captivate attention and boost interaction rates.
          </p>
        </div>
