...
const benefits = [
  { icon: "🔒", text: "Bulletproof Deliverability" },
  { icon: "📲", text: "Instant Global Reach" },
  { icon: "⚙️", text: "Plug & Play Integration" },
  { icon: "📈", text: "Optimized for Conversions" },
];

const VerificationAbout = () => {
    return (
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1">
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold leading-snug bg-gradient-to-b from-black to-[#001e80] bg-clip-text text-transparent">
                       Secure, Scalable Verification Messaging
                    </h2>
                    <p className="mt-6 text-base text-[#183ec2]">
                        Power global user verification via carrier-grade A2P messaging infrastructure.
                    </p>
