...
const benefits = [
  { icon: "📊", text: "Trackable campaign performance" },
  { icon: "⚡", text: "Real-time delivery reports" },
  { icon: "🎯", text: "Targeted audience segmentation" },
  { icon: "🔒", text: "Compliant & secure routing" },
];
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1">
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold leading-snug bg-gradient-to-b from-black to-[#001e80] bg-clip-text text-transparent">
                        Smart Messaging That Converts Fast
                    </h2>
                    <p className="mt-6 text-base text-[#183ec2]">
                       Deliver laser-targeted promotional SMS at scale with full campaign control and transparency.
                    </p>
