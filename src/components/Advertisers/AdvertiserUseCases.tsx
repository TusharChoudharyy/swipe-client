      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 px-4 max-w-4xl mx-auto">
            Drive measurable customer acquisition through performance networks
          </h2>
          <p className="text-m  mx-auto max-w-3xl">
            Unlock scalable growth by partnering with targeted affiliates, optimizing campaigns, and maximizing ROI across global digital ecosystems.
          </p>
        </div>
