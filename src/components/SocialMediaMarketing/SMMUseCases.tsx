      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 px-4 max-w-4xl mx-auto">
            Build strong digital presence with social media power
          </h2>
          <p className="text-m  mx-auto max-w-3xl">
            Scale brand influence with targeted campaigns across platforms, leveraging influencers, trends, and measurable community engagement.
          </p>
        </div>
